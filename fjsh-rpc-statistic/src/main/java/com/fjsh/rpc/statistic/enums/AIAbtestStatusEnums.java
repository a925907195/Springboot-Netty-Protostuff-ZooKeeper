...
public enum AIAbtestStatusEnums{
	
	alltime("0", "一分钟内请求耗时"),
	alltimeavg("0-1", "总体请求次数"),
	...
	AIAbtestStatusEnums(String type, String description){
	...
	// 获得枚举的状态
	public static AIAbtestStatusEnums getEnumByType(String type){
